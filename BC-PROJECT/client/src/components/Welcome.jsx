...
const Welcome = () => {
    ...
    return (
        <div className='flex   border-1    justify-center items-center white-glassmorphism respo'>
            <div className='flex mf:flex-row  flex-col md:w-4/5   items-start justify-between md:w-full md:p-10 py-12 px-4'>
                <div className='flex flex-1  justify-start flex-col mf: mr-10 resp'>
                    ...
                    {currentAccount && (<p className='flex flex-row justify-center items-center my-5  p-3  '>
                            <p className=' px-2 py-2 text-lime-400 text-2xl brightness-1000'>
                                CONNECTED !
                            </p>
                        </p>)
                    }

                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10 hidethis">
                ...
                <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
                    <div className='p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism'>
                        <div className='flex justify-between flex-col w-full h-full'>
                            ...
                            <div>
                                <p className='text-white font-light text-sm text-ellipsis overline'>
